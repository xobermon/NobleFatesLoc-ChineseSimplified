This is the Official Simplified Chinese Translation of Noble Fates. New strings will be added here when the game receives updates.
...
```
{
    id Oct.Localization.Languages.ChineseSimplified
...
When you run the game, your translations should take effect when you switch to 简体中文.
